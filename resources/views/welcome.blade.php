...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
        @auth
            <!-- Display user's name with profile and logout options -->
            <div class="flex items-center">
                <span class="text-white mr-4">{{ Auth::user()->name }}</span> <!-- Display user name -->
                
                <!-- Profile link -->
                <a href="{{ route('profile.edit') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    {{ __('Profile') }}
                </a>
        ...
        @else
            <!-- Log in and Register links for unauthenticated users -->
